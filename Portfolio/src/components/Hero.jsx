...
function Hero() {
  return (
    <div className='bg-lightBlack text-white flex md:flex-row flex-col-reverse xl:px-32 lg:px-20 md:px-12 px-6 md:justify-between justify-center items-center md:mb-20'>
        <div className="mt-[450px] mb-32 md:my-[40px] lg:my-20 xl:my-24 md:text-start text-center ">
          ...
          <h3 className="text-[15px] text-[500] leading-[28px] tracking-[2.3px] underline hover:text-cyan underline-offset-8  decoration-cyan "><Link to="/contact">CONTACT ME</Link></h3>
        </div>
